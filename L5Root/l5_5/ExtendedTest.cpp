...
void testAdd() {
	...
	// cout << "BAAAAAAAAAAAAAAAAAAAAAAAAAAA 11111111111\n";
	for (int i = 0; i < 10; i++) {
		// cout << "i = " << i << '\n';
		// if (i == 3) { m.apel_display(); }
		assert(m.add(i, i) == i);
	}
	for (int i = 10; i < 20; i++) { 
		assert(m.add(i, i) == NULL_TVALUE);
	}
//	cout << "BAAAAAAAAAAAAAAAAAAAAAAAAAAA 222222222222\n";
	assert(m.isEmpty() == false);
	assert(m.size() == 30);
	// cout << " pana aici nu !\n";
...
//	cout << " aici de 2 ori !\n";
	...
	assert(m.isEmpty() == false);
	assert(m.size() == 200);
	// cout << "BAAAAAAAAAAAAAAAAAAAAAAAAAAA 44444444444\n";
