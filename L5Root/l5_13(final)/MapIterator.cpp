...
/*
worst case = O(m), deci Theta(m) - elementul nu exista deloc / se afla chiar pe ultima pozitie in tabela respectiva
average case = O(m)
...
/*
Depinde de complexitatea lui `find_next`;
worst case = O(2m) = O(m) - elementul nu exista deloc / se afla pe ultima pozitie din tabela2
average case = O(m)
best case = Omega(1), deci chiar Theta(1) - elementul se afla pe prima pozitie in prima tabela
*/
