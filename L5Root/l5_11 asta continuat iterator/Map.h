...
public:
	...
	void apel_display() const; /* stiu ca e un pic ciudat sa fac asta (o sa vedeti in .cpp ca eu in metoda asta pur si simplu 
	apelez metoda privata `display` de mai sus, dar pe moment asta mi s-a parut singura alternativa la: a nu fi avut metoda `display` publica )*/

	// de aici in jos e interfata asa cum am descarcat-o ( specificatiile pentru fiecare metoda )
