...
bool valid(bool mat[][Nmax], bool aux[][Nmax], pozitie_plan p, int n, int m)
{
	...
	//if (valid_pozitie(p, n, m)) cout << "1BUN\n";
	//if (!obstacol(mat, p)) cout << "2BUN\n";
	//if (valid_nevizitat(aux,p)) cout << "3BUN\n";
...
//		q.toString();
		...
		cout << "pozitie curenta: " << current_pos.i << " " << current_pos.j << '\n';
...
//	afis_mat<bool>(mat, n, m);
	...
	*/
	...
	/*
	Queue q;
	q.push(pozitie_plan{ 1,3 });
	q.push(pozitie_plan{ 2,4 });
	q.push(pozitie_plan{ 5,1 });
	q.push(pozitie_plan{ 6,8 });
